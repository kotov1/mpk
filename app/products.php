					...
					<div class="row align-items-center no-gutters">
						<div class="col-12 col-xl-6">
							<div class="product__info-inner">
								<h3 class="product__name">Труба горячекатная</h3>
								<p class="product__descr">Компания ТК Метало-Промышленная компания предлагает трубу гк, ГОСТ 8732-78. В ассортименте труба размером от 32*3 до 426х16, сталь марки  09Г2С. ТУ 14-3-1128-2000, ТУ 14-3р-44-2001.</p>
								<p class="product__descr">Трубы стальные бесшовные горячедеформированные в соответствии с сортаментом ГОСТ 8732-78 изготавливаются по наружному диаметру, толщине стенки и длине в различных модификациях.</p>
							</div>
						</div>
						<div class="col-12 col-xl-6">
							<div class="product__img">
								<img src="img/product-img.jpg" alt="Труба горячекатная" class="img-responsive">
							</div>
						</div>
					</div>
					<!-- row end -->
